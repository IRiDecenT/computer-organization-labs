...
10. ori 2(rt) 2(rs) imm16(1000 1111 0110 1100)  	00110100010000101000111101101100	34428F6C 	ori对立即数是零扩展该指令计算	FFFF FFA8 | 0000 8F6C = qFFFF FFEC	即指令执行完后2号寄存器值由FFFF FFA8 变为**FFFF FFEC**
